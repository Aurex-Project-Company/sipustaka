...
$query = "SELECT * FROM categories WHERE name LIKE ? LIMIT ?, ?";
...
// Count Data
$count_query = "SELECT COUNT(*) as total FROM categories WHERE name LIKE ?";
...
$no = 1;
?>
<h2 class="text-2xl mb-3">Kategori Buku</h2>
<div class="bg-white p-6 rounded shadow">

  <div class="flex flex-wrap items-center justify-between gap-2 mb-4"">
    <a href="index.php?page=categories-add" class="px-4 py-2 bg-slate-800 text-white rounded-md hover:bg-slate-700 focus:ring-2 focus:ring-slate-500 transition">
      Tambah
    </a>
          ...
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-4 py-3 text-center space-x-2">
              <div class="flex justify-center items-center gap-2">
                <a href="index.php?page=categories-edit&id=<?= encryptId($item['id']) ?>" class="px-3 py-1 text-xs bg-blue-100 text-blue-700 rounded hover:bg-blue-200">
                  Edit
                </a>
                <form action="index.php?page=categories-delete" method="POST">
